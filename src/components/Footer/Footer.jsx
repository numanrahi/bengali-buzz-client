...
const Footer = () => {
	return (
		<div className="w-100 footer back-dark">
			...
			<div className="w-100 mx-auto row py-2">
				<div
					...
					className="btn mx-auto col-11 col-sm-5 title-text text-black fs-4 fw-bold rounded-0 py-2 bg-white btn-secondary"
				>
					Subscribe
				</div>
			</div>
					...
					<div className="d-flex flex-column align-items-center ms-2 py-2 ">
						<div className="mb-2">
							<div className="text-center">
								2523 Silicon Valley , California
							</div>
						</div>
						<div className="mb-2">info@buzz.com</div>
			...
			<div className="text-center pt-3">
				All Rights Reserved | &copy;Bengali Buzz
			</div>
		</div>
	);
};
